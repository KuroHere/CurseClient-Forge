...
import com.curseclient.mixin.accessor.entity.IEntityPlayer
...
object PopChams : Module(
    ...
    private val outlineWidth by setting("Width", 3.5F, 0.1F, 10F, 0.1F)
    ...
    init {
        ...
        safeListener<Render3DEvent> {
            chams.forEach {
                ...
                glPolygonMode(GL_FRONT_AND_BACK, if (renderStyle == Style.FILL) GL_FILL else GL_LINE)
