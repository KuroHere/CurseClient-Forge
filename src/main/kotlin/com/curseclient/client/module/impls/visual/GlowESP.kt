...
import com.curseclient.client.utility.render.animation.animaions.decelerate.Animation
...
object GlowESP : Module(
    ...
    private fun setupGlowUniforms(
        ...
        glowShader.setUniformf("exposure", (exposure * fadeIn.getOutput()).toFloat())
    ...
    private fun setupOutlineUniforms(
        dir1: Float,
        dir2: Float
    ) {
        val color = getGlowColor()
