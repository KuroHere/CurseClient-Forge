package com.curseclient.client.module.impls.hud.modulelist
...
import com.curseclient.client.module.impls.hud.modulelist.ModuleList.animationMode
import com.curseclient.client.module.impls.hud.modulelist.ModuleList.font
...
class ModuleListElement(
    ...
    private fun getSmoothedProgress() = EaseUtils.getEase(progress.toDouble(), EaseUtils.EaseType.OutCubic).toFloat()
