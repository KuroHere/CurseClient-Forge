...
public class TrackerPlayerBuilder extends TrackerPlayer {
    ...
    public TrackerPlayerBuilder(String content) {
        this(null, content,null, false);
    }

    public TrackerPlayerBuilder(String username, String content, String avatar_url) {
    ...
    public static class Builder {
        ...
        public Builder(String content) {
            this.message = new TrackerPlayerBuilder(content);
        }
